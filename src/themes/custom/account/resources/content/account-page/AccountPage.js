...
export class AccountPage extends React.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "DEFAULT_STATE", {
      ...
      formFields: {
        ...
        lastName: '',
        email: '',
        attributes: { phoneNumber: '', address: '', city: '', state: '', zipCode: '' }
      }
    });
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(ContentPage, {
      ...
      minLength: 10,
      maxLength: 14,
      value: fields.attributes.phoneNumber,
      onChange: this.handleChange,
      validated: this.state.errors.phoneNumber !== "" ? ValidatedOptions.error : ValidatedOptions.default
    })), /*#__PURE__*/React.createElement(FormGroup, {
      label: Msg.localize("address"),
      fieldId: "address",
      helperTextInvalid: this.state.errors.address,
      validated: this.state.errors.address !== "" ? ValidatedOptions.error : ValidatedOptions.default
    }, /*#__PURE__*/React.createElement(TextInput, {
      isRequired: true,
      type: "text",
      id: "address",
      name: "address",
      maxLength: 254,
      value: fields.attributes.address,
      onChange: this.handleChange,
      validated: this.state.errors.address !== "" ? ValidatedOptions.error : ValidatedOptions.default
    })), /*#__PURE__*/React.createElement(FormGroup, {
      label: Msg.localize("city"),
      fieldId: "city",
      helperTextInvalid: this.state.errors.city,
      ...
      name: "city",
      maxLength: 254,
      value: fields.attributes.city,
      onChange: this.handleChange,
      validated: this.state.errors.city !== "" ? ValidatedOptions.error : ValidatedOptions.default
    })), /*#__PURE__*/React.createElement(FormGroup, {
      label: Msg.localize("state"),
      fieldId: "state",
      helperTextInvalid: this.state.errors.state,
      validated: this.state.errors.state !== "" ? ValidatedOptions.error : ValidatedOptions.default
    }, /*#__PURE__*/React.createElement(TextInput, {
      isRequired: true,
      type: "text",
      id: "state",
      name: "state",
      maxLength: 14,
      value: fields.attributes.state,
      onChange: this.handleChange,
      validated: this.state.errors.state !== "" ? ValidatedOptions.error : ValidatedOptions.default
    })), /*#__PURE__*/React.createElement(FormGroup, {
      label: Msg.localize("zipCode"),
      fieldId: "zipCode",
      helperTextInvalid: this.state.errors.zipCode,
      validated: this.state.errors.zipCode !== "" ? ValidatedOptions.error : ValidatedOptions.default
    }, /*#__PURE__*/React.createElement(TextInput, {
      isRequired: true,
      type: "text",
      id: "zipCode",
      name: "zipCode",
      maxLength: 14,
      value: fields.attributes.zipCode,
      onChange: this.handleChange,
      validated: this.state.errors.zipCode !== "" ? ValidatedOptions.error : ValidatedOptions.default
